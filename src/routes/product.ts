...
import { createProduct, deleteProduct , getProductsFile, product, suggest_product_price, updateProduct, uploadImage, uploadProductsFile} from "../controllers/product-controller";
