...
const changePasswordCompany_ = (dataToken, newData, callback) => {
    ...
    try {
        db_config_1.default.query(getQuery, [id], (err, result) => __awaiter(void 0, void 0, void 0, function* () {
            if (err) {
            ...
            if (result.length > 0) {
                ...
                if (isMatch) {
                    ...
                    db_config_1.default.query(updatePassQuery, [newPassword, id], (err, result) => {
                        if (err) {
                            callback({ "Error de base de datos": err });
                        }
                        else {
