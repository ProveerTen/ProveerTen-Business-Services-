...
router.get('/companiesUserCero/:id', profile_controller_1.companies); // para usuario cero
...
router.get('/allCompaniesUserCero', profile_controller_1.allCompanies); // para usuario cero
